      ...
      case 1:
        return (
          <div className="flex flex-col space-y-2">
            ...
            <label htmlFor="work_location" className="text-sm font-medium text-gray-700">Work Location</label>
            <select
      ...
      case 2:
        return (
          <div className="flex flex-col space-y-2">
            ...
            <label htmlFor="employee_code" className="text-sm font-medium text-gray-700">Employee Code</label>
            <input
