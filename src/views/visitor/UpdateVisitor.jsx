  ...
  const stepContent = (step) => {
    switch (step) {
      ...
      case 1:
        return (
          <div className="flex flex-col space-y-2">
            <label htmlFor="visitor_type" className="text-sm font-medium text-gray-700">
              Visitor Type
            </label>
            <select
      ...
      case 2:
        return (
          <div className="flex flex-col space-y-2">
            <label htmlFor="gov_id_type" className="text-sm font-medium text-gray-700">
              Government ID Type
            </label>
            <select
            ...
            <label htmlFor="gov_id_no" className="text-sm font-medium text-gray-700">
